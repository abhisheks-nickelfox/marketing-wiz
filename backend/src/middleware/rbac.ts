...
/**
 * Requires the authenticated user to have any valid role (admin, member, or project_manager).
...
export function requireMember(
  ...
  if (!MEMBER_ROLES.includes(req.user.role as 'admin' | 'member' | 'project_manager')) {
